...
const projects = [
    {
        ...
        techStack: ["Python", "Networking", "Socket Programming", "Fast API", "Next JS", "MITM Proxy"],
    ...
    },
    {
        ...
        techStack: ["Django", "Python", "Postgres"],
        demoLink: "", // Add if available
    ...
    },
    {
        ...
        techStack: ["Python", "Machine Learning", "OpenCV", "Tkinter"],
        demoLink: "", // Add if available
